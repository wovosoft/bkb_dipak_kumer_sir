    ...
    <div>
        <the-table :datatable="datatable" :fields="fields">
            ...
            <b-table
                ...
                :api-url="baseUrl+'/backend/divisional_offices'"
                v-bind="{...attrs}">
                <template #cell(action)="row">
                    <b-button-group size="sm">
                        ...
                        <b-button variant="dark"
                                  title="Branch List"
                                  @click="getCrmRmOffices(row.item)"
                                  v-b-toggle:crm_rm_offices>
                            <b-icon-list/>
                        </b-button>
                    </b-button-group>
                </template>
...
export default {
    ...
    methods: {
        ...
        handleSubmit() {
            axios
                .post(this.baseUrl + "/backend/divisional_offices/store", JSON.parse(JSON.stringify(this.currentItem)))
                .then(({data}) => {
                    console.log(data)
